...
#
# Usage:
# vivado -mode batch -source red_pitaya_vivado_project_Z20_14.tcl -tclargs boot
################################################################################
...
# add_files                         $path_bd
 ...
 add_files      					$path_rtl/UART_wrapper.v
 add_files -fileset constrs_1       $path_rtl/Zeus.xdc
